...
def get_dashboard_data(date_filter=None, db_session=None, models=None):
    ...
    try:
        ...
        if models is not None and db_session is not None:
            ...
            from app import db as app_db, Invoice, Customer, Company, PurchaseOrder, Vendor, InvoiceItem
        ...
        return {
            'revenue_metrics': {'total_revenue': 0, 'current_month_revenue': 0, 'previous_month_revenue': 0, 'revenue_growth': 0, 'ytd_revenue': 0, 'avg_invoice_value': 0, 'week_revenue': 0, 'quarter_revenue': 0},
